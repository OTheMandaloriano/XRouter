export default {
  ...
  models: [
    ...
    { id: "gpt-5.4-image-2", name: "GPT 5.4 Image 2", capabilities: ["text2img","edit"], params: ["size","quality","background","image_detail","output_format"], kind: "image" },
